...
#define MODELSEL		PORTBbits.RB5
#define MODELSELIO 		TRISBbits.TRISB5		//For direction
#define MODELSELLAT		LATBbits.LATB5			//for write data

#define MODELSEL1	    PORTCbits.RC2			//MOTOR OVERLOADING SIGNAL
#define MODELSEL1LAT	LATCbits.LATC2			//for write data
#define MODELSEL1IO 	TRISCbits.TRISC2		//For direction
