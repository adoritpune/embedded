...
int main()
{
	...
	else if(mc_model=='B')		//MMA-TIG-MIG-FCAW-600A
	{
		...
		maxmigwf		=250.0;		// 180.0 changed on 02112020 COFMOW requirement of max speed.
...
*/
	...
	DISICNTbits.DISICNT=0x3FFF;
	{
		...
		win1[2]='R';
		win2[0]='2';
		win2[1]='2'; //Rev changed from 2.1 to 2.2 for COFMOW SS 1.2/1.6 synergic data// Rev changed from 2.0 to 2.1 for COFMOW wirespeed change from 180 to 250
		win2[2]=mc_model;
		win1dpcnt=3;
		win2dpcnt=3;
		for(i=0;i<4000;i++)
						...
						para.weld.wfs=updatedata(para.weld.wfs,min.weld.wfs,maxmigwf,encres1);
					     {
							do
							{
								...
								temp1=para.weld.wfs;
								fwirespeed=temp1*0.101;//30;
								if(fwirespeed <= fwirespeed_max) //-------------fwirespeed_max=22
								{
									fpwmtime=fwirespeed*3.0;
									para.pwmtime=fpwmtime;								
								}
