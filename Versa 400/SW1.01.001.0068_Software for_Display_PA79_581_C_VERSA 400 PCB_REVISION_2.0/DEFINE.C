...
#define MTR_PWM_SLOPE				6.0 //6.5	//5.5		//7.0	    //5.5  for 20Khz   6.5 is the speed of motor 
#define MTR_PWM_OFFSET				1	//55.0	//70.0		//10.0 for 20Khz

#define MTR_FB_SLOPE		180   //180	 //2.19 //1.49435
#define MTR_FB_OFFSET		5  //5	 //27.75652
