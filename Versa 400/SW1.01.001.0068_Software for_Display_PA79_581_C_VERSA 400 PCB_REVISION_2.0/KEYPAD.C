...
void key_application(unsigned char keypressed)//@called in main.c ==> while(1){ }
{
	if(keypressed =='A') 
	{
		...
		{
			/////////////////////////////////////////offset min and max start////////////////////////////////////////////////////////////
			if(cVoltoffMenuMode==1)             // for min volt
			{
				if(vOffset >= 14)
				{
					vOffset = vOffset - 1;		
			...
			if(cVoltoffMenuMode==2)       // for max volt 
	   
		    { 
			    if(vOffset <= 420)
				{
				    vOffsetmax = vOffsetmax - 1;  //PPC	
				}
			 			 					
            }
		}
            //////////////////////////////////////////offset min and max end///////////////////////////////////////////////////////
			if(cMIGMenuMode==1)
			{
				if(mig_preflow >= 1)
				{
	...
	else if((keypressed =='D'))// && (weldmode=='G')) 
	{
		...
		{
			///////////////////////////////////////////////////////////////////////////////////////////////
			if(cVoltoffMenuMode==1) //offset volt min
			{
		...
		/*	if(cVoltoffMenuMode==2) //offset volt max
			{
				vOffsetmax = vOffsetmax + 1;  //PPC
