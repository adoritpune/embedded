		...
		if(keyreadf==1)
		{
			...
			{		
		 	...
		 	{		
				...
				{						
					key_application('B'); 
                    if(cVoltageoffsetmenu == 1 && cVoltageoffsetfg == 0)
                    {
						cVoltageoffsetmenu=0;
                    } 
...
void ADC_Reference(void)
{
    ...
    {   
		...
		if(iWireFeeder_error >= 670)     //450,550
		{
			WireFeeder_errorf=1;
		}
		else
