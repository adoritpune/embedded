...
#define	CCOFFSETNEW	  65//55.0//46.47   
#define CCSLOPENEW	  4.559//4.559
#define CCSLOPENEW2	  4.2//4.559

#define CCSLOPENEW_1STAG	4//4.0   //4
#define	CCOFFSETNEW_1STAG	  60
#define CURRENT_DISP_MMA	5
...
#define DEFAULTLOADONCNTR	60000			//30 Sec
#define DEFAULTMIGMINPROGRAM	201
#define DEFAULTMIGROOTMINPROGRAM	301									
#define DEFAULTPMIGMINPROGRAM	2
#define MIGMINPROGRAMLOAD		250
#define PMIGMINPROGRAMLOAD		50
//-------------------------------------------------------
...
//-------------------------------
#define STARTPULSECNT		5
#define ENPULSECNT			4
#define WAITTOSTOPCNT		50
#define STARTPULSECURRENT	480
//-------------------------------
...
// E2p Address
#define ADOR_WR				0x7FE0	
#define MIG_PROGRAM_ADDR		0x0010
#define PMIG_PROGRAM_ADDR		0x0012
//-----------------------------------------------------------------------------

/*//-----------------------------------------------------------------------------
#define E2POFFSET						128
// E2p address list
#define PROG_NO							1
#define PROG_NAME						PROG_NO+1
#define GAS_DIA							PROG_NAME+7
#define SYN_DATA						GAS_DIA+1
#define PMIG_PARA						SYN_DATA+22*4
...
//------------------------------------------------------------------------------
#define MACHINE_ID_ADDR				0X0002						//Start address of four bytes of machine ID
#define USB_FILE_CNTR_ADDR			0x0006						//2 bytes of file cnter stored in External EEPROM

#define OCVMANIPULATIONADDR			0x0008						//1 byte only OCV Display status ==> flag 0 = OCV 78 ==> flag 1 = OCV Actual in MMA Mode.

#define MSVOLTAGEOFFSETADDR			0x0009					//Actual Voltage manipulation for MS wire 1 Byte

#define ARC_MISSING_DLY				2000						//
#define FILE_SAVE_OPEN_DLY			60000
//-----------------------------------------------------------------------------

#define HOT_START_SET_CURR_LMT 			200

#define ARCLENGTH_DWN_CNT   		10000
//---------------------------------------------------------------------------
#define ALDIA						0	// 0 = Al 1.2 and 1 = Al 1.6
//---------------------IOT---------------------------------------------------
#define SERIALPORTFORIOT			1
#define STARTCHAR					'@'
#define ENDCHAR						'$'
#define CR							0X0D
#define LF							0X0A

#define JSON_SOFTWAREREV			4
#define JSON_WELDPROCESS			8
#define JSON_WELDMODE				9
#define JSON_WIRESPEED				10
#define JSON_SETCURRENT				11
#define JSON_SETVOLTAGE				12
#define JSON_MATERIAL				13
#define JSON_DIAMETER				14
#define JSON_GAS					15
#define JSON_WELDING				20
#define JSON_ACTCURRENT				21
#define JSON_ACTVOLTAGE				22
#define JSON_ERROR					23
#define JSON_ARCONTIME				24
...
#define DATA_REFRESH_CNT			1000;
#define ERROR_FLASH_CNT				5000;
#define POWERONDLYCNT				1200;
//-----------------------------------------------------------------------------
