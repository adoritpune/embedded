...
/*********************EEPRROM READ AT START=end	*******************/
   ...
   else
   {
	...
	pidParams2.Kp2	=9;//20.0;//5;
	pidParams2.Ki2	=7;//5.0;//10
	pidParams2.Kd2	=17;//0;//20 //5
	 

	
	//uiFristP=225;uiFristDW=134;//uiSecondP=260;
...
//		lcdput(7,80,cGasPercent[pgas]);				
		...
		diswin1[2]	='V';
		diswin2[0]	='2';
		diswin2[1]	='5';  //rev 1.2 @sbm//1.3 changed on 19092019//rev 1.4 changed on 23092019
		diswin2[2]	='0';
				...
				else if((key=='F'))
				{
			    	...
			    	if((lcd_update_password == 1)&&(temp_password==MASTER_PASSWORD))
				    {
						...
						else
						{
							...
							{ 
								iLoadBlockCnt = DEFAULTMIGROOTMINPROGRAM;
...
void updategcvparameter(unsigned char encres3, unsigned char encres2)
{
	if(encres3!='$')
	{
		if(maxwirespeedrootfg==1)
		{
			
			para.migmode.setwspeed=updatedata(para.migmode.setwspeed,mini.migmode.setwspeed,para.migmode.setwspeed,encres3);
...
//$$$$$$$$$$$$$$$$$$$$$$$$$Control will never enter in to this section (for pulse mig different function is written)$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$		
		...
		{
			pidParams2.migweldmode=updatedata(pidParams2.migweldmode,0,1,encres1);
				
		}
		
		else if(lcdmigpointer==10)
		{
			pidParams2.Kp2=updatedata(pidParams2.Kp2,0,100,encres1);
	
		}
		else if(lcdmigpointer==11)
		{
			pidParams2.Ki2=updatedata(pidParams2.Ki2,0,100,encres1);
	
		}
		else if(lcdmigpointer==12)
		{
			pidParams2.Kd2=updatedata(pidParams2.Kd2,0,100,encres1);
