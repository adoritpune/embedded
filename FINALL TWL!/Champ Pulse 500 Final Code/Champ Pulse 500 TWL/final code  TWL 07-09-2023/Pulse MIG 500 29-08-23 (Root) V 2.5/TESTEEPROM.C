...
void write_mode_mem(unsigned char cMemoryLocation)
{
	...
	if(weldmode=='G')  //@ mig welding mode
	{
		...
		EEPROM_Erase_Write_for_SaveRecall((eeprom_location+19*2),pidParams2.migweldmode);  	 //17 Mode selection 
...
//	}
	...
	{ 
		...
		pidParams2.migweldmode		=EEPROM_Read_for_SaveRecall((eeprom_location+19*2));  	//12 creep speed  twinpulsefreq
...
/********************************Arc On Time**************************/
	...
	if(weldmode=='G')    
	{
		...
		para.migmode.inductance		=EEPROM_Read_for_SaveRecall((eeprom_location+11*2));  	//11 inductance=G/arc_length=P
		para.creepspeedrate			=EEPROM_Read_for_SaveRecall((eeprom_location+12*2));  	//12 creep speed  twinpulsefreq
		pidParams2.migweldmode		=EEPROM_Read_for_SaveRecall((eeprom_location+19*2)); 	//17 Mig Mode Selection
...
//		para.pulseweldmode=EEPROMstruct_mig.p_mode;  //only for P-mig
	    ...
	    read_mig_mode = pidParams2.migweldmode;             //17
...
/********************************Arc On Time**************************/
	...
	//	EEPROMstruct_mig.p_mode=para.pulseweldmode;  //only for pulse mode
		...
		{
			EEPROM_Erase_Write_for_SaveRecall((eeprom_location+19*2),pidParams2.migweldmode);  		 //17 mig mode selection
...
//			mat=para.migmode.gmaterial;
		...
		if(pidParams2.migweldmode!=1 && pidParams2.migweldmode!=0)
		{		
			pidParams2.migweldmode=1;
			EEPROM_Erase_Write_for_SaveRecall((eeprom_location+13*2),pidParams2.migweldmode);  		 //12 creep speed  twinpulsefreq
			read_mig_mode=pidParams2.migweldmode;	
		}
