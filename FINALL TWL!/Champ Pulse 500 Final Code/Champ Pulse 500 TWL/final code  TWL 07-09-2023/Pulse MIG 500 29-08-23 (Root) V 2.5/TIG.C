			...
			{	
				...
				if(SPI2STATbits.SPITBF==0)
				{
					//DACCSLAT	=0;
				     ...
				     if(para.tigmode.setcurrent<=51)
					{
						  daccount=(para.tigmode.setcurrent*6.5)-CCOFFSETNEW;
						  SPI2BUF		=28672+daccount;     //850;//1000=50A, 850=30A , 900=40A;//+(2*arclength);// 40A  400;//Refbasecnt;
					}
					else if(para.tigmode.setcurrent>=52 && para.tigmode.setcurrent<=200)
					{
						  daccount=(para.tigmode.setcurrent*5.7)-CCOFFSETNEW;
						  SPI2BUF		=28672+daccount;     //850;//1000=50A, 850=30A , 900=40A;//+(2*arclength);// 40A  400;//Refbasecnt;
					}
					else{
						
						 daccount=(para.tigmode.setcurrent*5.3)-CCOFFSETNEW;
					     SPI2BUF		=28672+daccount;     //850;//1000=50A, 850=30A , 900=40A;//+(2*arclength);// 40A  400;//Refbasecnt;
