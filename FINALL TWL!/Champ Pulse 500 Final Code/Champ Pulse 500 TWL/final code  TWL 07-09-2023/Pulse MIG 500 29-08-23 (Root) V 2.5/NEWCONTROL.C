...
void INT_sck_voltage_pid()
{
   ...
   {
      INT_sckpidParams.INT_sckKp=pidParams2.Kp2;//2;//pidParams1.Kp1;//pidkp;//pidParams1.Kp1;//50.0;//40.0;//20.0//10.0 //100.0;// pidParams1.Kp1
      INT_sckpidParams.INT_sckKi=pidParams2.Ki2;//4;//pidParams1.Ki1;//pidki;//pidParams1.Ki1;//5.0;//10.0;//2.0;//1.0 //0.5;//0.2;
      INT_sckpidParams.INT_sckKd=pidParams2.Kd2;//1;//pidParams1.Kd1;//pidkd;//pidParams1.Kd1;//p120.0;//10.0 ;2.0;//0.50;//0.02;
      INT_sckpidParams.INT_sckTsampling=1;
