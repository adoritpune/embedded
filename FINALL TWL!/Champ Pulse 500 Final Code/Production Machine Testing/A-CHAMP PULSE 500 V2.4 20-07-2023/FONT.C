...
unsigned char character[128][8] = {
	                           {  0,   0,   0,   0,   0,   0,   0,   0}, //0
	                           {126, 129, 149, 177, 177, 149, 129, 126}, //1 smiley
	                           {126, 255, 235, 207, 207, 235, 255, 126}, //2 smiley
							   { 14,  31,  63, 126,  63,  31,  14,   0}, //3 heart
							   {  8,  28,  62, 127,  62,  28,   8,   0}, //4
							   { 24, 186, 255, 255, 255, 186,  24,   0}, //5
							   { 16, 184, 252, 255, 252, 184,  16,   0}, //6
							   ...
							   {192, 255, 127,   5,   5, 101, 127,  63}, //14 -|> //16
							   {153,  90,  60, 231, 231,  60,  90, 153}, //15 <|-
							   {127,  62,  62,  28,  28,   8,   8,   0}, //16 up/down arrow
							   {  0, 128, 224, 248, 254, 248, 224, 128}, //17
							   {  0,   1,   7,  31, 127, 31,    7,   1}, //18
							   ...
							   {  0,   4,   6, 127, 127,   6,   4,   0}, //24 arrow up
							   {  0,  16,  48, 127, 127,  48,  16,   0}, //25 arrow down
							   {  8,   8,   8,  42,  62,  28,   8,   0}, //26 arrow left
				   			   {  8,  28,  62,  42,   8,   8,   8,   0}, //27 arroe right
							   ...
							   { 62, 127, 113,  89,  77, 127,  62,   0}, //48 0
							   { 64,  66, 127, 127,  64,  64,   0,   0}, //49 1
							   ...
							   {124, 126,  19,  19, 126, 124,   0,   0}, //65 A  
							   ...
							   { 71,  99, 113,  89,  77, 103, 115,   0}, //90 Z
							   {  0, 127, 127,  65,  65,   0,   0,   0}, //91 [
							   {  1,   3,   6,  12,  24,  48,  96,   0}, //92 
							   {  0,  65,  65, 127, 127,   0,   0,   0}, //93 ]
							   {  8,  12,   6,   3,   6,  12,   8,   0}, //94 ^
							   {128, 128, 128, 128, 128, 128, 128, 128}, //95 _
							   {  0,   0,   3,   7,   4,   0,   0,   0}, //96 `
							   { 32, 116,  84,  84,  60, 120,  64,   0}, //97 a  
