...
unsigned char temp_tig_weld=0;	
		...
		//	HFRELAYLAT	=OFF;						//TO CONTROL THE HF RELAY
			...
			{	
				...
				{
					DACCSLAT	=0;
					if(para.tigmode.setcurrent <= 75)//122)
					{
					   daccount=(para.tigmode.setcurrent*CCSLOPENEW_1STAG)-CCOFFSETNEW;
					   SPI2BUF		=28672+daccount;     //850;//1000=50A, 850=30A , 900=40A;//+(2*arclength);// 40A  400;//Refbasecnt;CCSLOPENEW_1STAG
