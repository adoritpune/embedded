...
#define MMACCSLOPE		3.15//2.0//2.25 //2.072   //3.9225
#define MMACCOFFSET		450.0//610.0//510.0//610.0 //470.0 //427.0

//-----------------------------------------
#define MMACCSLOPE100		3.25//1.05
#define MMACCSLOPE200		1.45
#define MMACCSLOPE400		1.70
#define MMACCSLOPE600		1.80
#define MMACCSLOPE700		2.07

#define MMACCOFFSET100		470.0
