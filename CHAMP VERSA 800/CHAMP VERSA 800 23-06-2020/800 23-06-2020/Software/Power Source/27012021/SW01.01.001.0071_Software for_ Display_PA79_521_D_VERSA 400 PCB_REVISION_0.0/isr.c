		   	...
		   	else
		   	{
				...
				if(weldcurrent >=offset)
				{
					...
					{ //imbal is approximately 1/5th of total current
							...
							imbal=(40.0*shfbweldcurr)/100.0;// 30 to 25 changed on 22012020
							else
							imbal=100; 
					}
					else
					{
						imbal=(50.0*shfbweldcurr)/100.0;
					}	


				    //display weldcurrent
				    if(weldcurrent <= 200.0)                                    //390
						dispweldcurrent=weldcurrent+((600.0-weldcurrent)*0.1);
					else if((weldcurrent > 200.0) && (weldcurrent < 590.0))                                    //390
						dispweldcurrent=weldcurrent+((600.0-weldcurrent)*0.15);
