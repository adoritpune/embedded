...
#define MMACCSLOPE		3.1//2.0//2.25 //2.072   //3.9225
#define MMACCOFFSET		490.0////610.0//510.0//610.0 //470.0 //427.0

//-----------------------------------------
#define MMACCSLOPE100		4.0
#define MMACCSLOPE200		1.45
#define MMACCSLOPE400		1.70
#define MMACCSLOPE600		1.80
#define MMACCSLOPE700		3.08

#define MMACCOFFSET100		490.0
#define MMACCOFFSET700		490.0

#define CURRENT100			110
