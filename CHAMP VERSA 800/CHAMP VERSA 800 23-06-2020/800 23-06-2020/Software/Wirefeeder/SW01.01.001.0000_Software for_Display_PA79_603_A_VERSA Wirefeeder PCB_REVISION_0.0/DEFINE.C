...
#define MTR_FREQ_CONSTANT_1 2.8//3.2//3.6//8//4.5   //4.5  //1.5//3.58
#define MTR_FREQ_CONSTANT_2 3.0
#define MTR_FREQ_CONSTANT_3 3.1
#define MTR_FREQ_CONSTANT_4 3.2
#define MTR_FREQ_CONSTANT_5 3.6
