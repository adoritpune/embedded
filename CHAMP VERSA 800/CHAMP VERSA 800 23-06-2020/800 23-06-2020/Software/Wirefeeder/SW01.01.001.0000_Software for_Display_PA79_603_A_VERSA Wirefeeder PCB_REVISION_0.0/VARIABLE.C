...
unsigned char i=0,plus111=0,minus111=0,firstpulse1=0,secondpulse1=0,plus222=0,minus222=0,firstpulse2=0,secondpulse2=0;
...
volatile unsigned char OneH=0x00,OneL=0x00,TwoH=0x00,TwoL=0x00,Count=0,onesecf=0,softstartf=0,rxdata=0,
                       txonf=0,count_2ms=0,read_enc1f=0,enccount=0,dispupdatef=1;
//volatile unsigned char fixintervalf=0,capintervalf=0,count_pid=0;
...
unsigned char startptr1=0,arrptr=0,recchksum=0,rec_arr[24],transmitonf=0,chksum=0,inchkeyon=0,inchcnt,send_statusf=0;
...
float Tsampling =1.0;
unsigned int scalefactor2=71.0,minfmspeed=50,scaled_baseval2=0,maxfmspeed=800;//950;//750;//2800;
unsigned char togglepin=1,closeloop1f=0;
unsigned char cWf2t4tmodefg,cEditfg;
...
unsigned int igascntr = 0;
unsigned char gaschkfg,motor_acceleratefg,motor_continuefg,cWeldStopfg ;
unsigned int up_count_motor;
//enum()
