...
//pid
int sf_setpoint, sf_feedback, sf_error, sf_preverror;
int sf_kpgain=0, sf_kigain=0, sf_kdgain=0;
long sf_outputmax=32000; //25600;
long sf_outputmin=0;
long sf_accumulator=0;
long sf_pterm=0,sf_iterm=0,sf_dterm=0,sf_pid;
int sf_scalefactor=10; //7
volatile unsigned int sf_pidoutput=0, scaled_sf_pidoutput=0, migdaccount;
...
unsigned int iAvg_cnt;iAvg_cntr=0,iNoofshift;
unsigned long resultmig=0;
//-----------------------------------------------------
unsigned char cTestfg,Testfg;
unsigned char cTest;
unsigned int iTest,ztemp=0;
unsigned char pidvaluesf,dispidvlauesf;
//-----------------------------------------------------
