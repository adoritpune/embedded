...
long sf_pterm=0,sf_iterm=0,sf_dterm=0,sf_pid=0,sf_pid_old=0;
int sf_scalefactor; //=7; //8; //7
volatile unsigned int sf_pidoutput=0, scaled_sf_pidoutput=0, migdaccount=0,migdaccount1=0,migdaccount2=0,iLowpidvalue,ishvalue;
