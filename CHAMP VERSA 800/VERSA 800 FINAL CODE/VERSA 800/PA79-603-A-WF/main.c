...
void key_application(unsigned char keypress)
{
    ...
    else if(keypress==key_disp)//'D')//Key_s4==1)
    {
        ...
        else if(Type.wirespeed==1)
        {
            diswin1[0]=0x73;
            diswin1[1]=0x25;
            diswin1[2]=0x25;
            disp_hex_window2(value1);
            value1=encod2;
            pstowfstr.rel_wirespeed = value1;
        }
        else if(Type.amp==1)
        {
            diswin1[0]=0x06;
            diswin1[1]=0x25;
            diswin1[2]=0x25;
            disp_hex_window2(value2);
            value2=encod2;
            pstowfstr.arclength = value2;
        }
        else if(Type.thickness==1)
        {
            diswin1[0]=0x5E;
            diswin1[1]=0x25;
            diswin1[2]=0x25;
            disp_hex_window2(value3);
            value3=encod2;
            pstowfstr.pulse_freq = value3;
        }
      }
        dispupdatef     =1;
