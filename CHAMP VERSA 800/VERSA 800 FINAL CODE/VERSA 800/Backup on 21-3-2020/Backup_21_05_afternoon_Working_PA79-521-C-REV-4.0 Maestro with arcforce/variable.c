...
unsigned char count_1ms,count_10ms,count_100ms,cali_flag,cali_on1,Disp_updatef=0,PrevTorchans=0,
              Torchans=0,softstartf=0,ii=0,iii=0,count_preflow=0,count_transmit=0,check=0;
...
unsigned int arcforce=0,newcurrent=0,hotstartcount=0,dvalcnt=0,startdf=0,dac_counts=0;
...
//pid
int sf_setpoint, sf_feedback, sf_error, sf_preverror,sf_ppreverror;
int sf_kpgain=0, sf_kigain=0, sf_kdgain=0;
long sf_outputmax=64000,sf_outputmaxx; //128000;//256000; //25600;
long sf_outputmin=0,sf_outputminn=0;
long sf_accumulator=0;
long sf_pterm=0,sf_iterm=0,sf_dterm=0,sf_pid;
int sf_scalefactor=7,sf_scalefactorr; //8; //7
volatile unsigned int sf_pidoutput=0, scaled_sf_pidoutput=0, migdaccount=0,migdaccount1=0,migdaccount2=0,iLowpidvalue,imfvalue,ishvalue,sf_pidoutputt;
...
//int *abcCoefficients[3],*controlHistory[3];
//int *PIDInit,*PIDCoeffCalc[2],*PID;
unsigned int fooPIDCoeffs[3];
//int *PID;
