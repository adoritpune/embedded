...
void Adaptive_base_pid()
{
        ...
        pidParams2.Kp2=2.0;//25.0;//25.0;//2.0;
        pidParams2.Ki2=0.5;//2.0;//2.0;//0.5;
        pidParams2.Kd2=0;//10.0;//10.0;//0;//0.50;//0.5;//2;
        ...
        pidParams2.outmax2=53000;//50000;
                        ...
                        else if(scaled_baseval2<minfmspeed)//baseamp)//200)
   			{
       			    scaled_baseval2=minfmspeed;//stepamp;//baseamp;//MAHESH200;
                        ...
                        if(cyclestrtf==1 && closeloopf==1)
                        {
                            ...
                            Update_PWM(MTR_FREQ_CONSTANT*newsetwirespeed);
                        }
