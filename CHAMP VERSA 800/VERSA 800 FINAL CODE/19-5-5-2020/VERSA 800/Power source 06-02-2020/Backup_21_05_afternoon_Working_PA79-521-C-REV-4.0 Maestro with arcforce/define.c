...
#define MIGCCOFFSET 1200.0 //20.88 //22//40.0//10          // 19-9-19
#define MIGCCSLOPE	1.5 //5.22 //6.6//12.0//12.0//4.559//3.6//

#define MMACCSLOPE		2.25 //2.072   //3.9225
#define MMACCOFFSET		610.0 //470.0 //427.0
