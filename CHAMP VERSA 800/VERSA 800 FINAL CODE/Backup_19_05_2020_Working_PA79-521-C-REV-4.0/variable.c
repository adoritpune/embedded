...
volatile unsigned int sf_pidoutput=0, scaled_sf_pidoutput=0, migdaccount=0,migdaccount1=0,migdaccount2=0,iLowpidvalue;
volatile unsigned char MIGweldon_detectf=0;
unsigned int imfvalue;
...
//-----------------------------------------------------
unsigned char cTestfg,Testfg,keyfoundfg;
unsigned char cTest;
unsigned int iTest;
