...
void __interrupt() INTERRUPT_InterruptManager (void)
{
    if(PIR0bits.TMR0IF == 1)  //1 MS
    {
        ...
        /*
        if((TIME_RESET_SWITCH == 0) && (cArcOnfoundfg == 0) && (cResetMenufg == 0))                    //SWITCH PRESSED
        {                
            iTimeResetSwitchcnt++;
        ...
        else if((TIME_RESET_SWITCH == 0) && (cArcOnfoundfg == 1) && (cResetMenufg == 0))
        {
            iTimeResetSwitchcnt++;
        ...
        else if((TIME_RESET_SWITCH == 1) && (cArcOnfoundfg == 1))
        {          
            iResetcnt1++;
            if(iResetcnt1 >= 5)
            {
        ...
        else if((TIME_RESET_SWITCH == 1) && (cResetMenufg == 1))
        {          
            iResetcnt1++;
            if(iResetcnt1 >= 5)
            {                       
        ...
        {    
            ...
            {         
                ...
                */
                ...
                else if((cModel_Select == 2)&&(ucBLE_CON_DIS==0))   //** APP Interlock Add
                {
