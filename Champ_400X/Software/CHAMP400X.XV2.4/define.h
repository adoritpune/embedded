...
/*
#define TIME_RESET_SWITCH       PORTAbits.RA5        // FOR READ
#define TIME_RESET_SWITCHIO     TRISAbits.TRISA5     // FOR INPUT OUTPUT
#define TIME_RESET_SWITCHLAT    LATAbits.LATA5       // FOR WRITE
*/
