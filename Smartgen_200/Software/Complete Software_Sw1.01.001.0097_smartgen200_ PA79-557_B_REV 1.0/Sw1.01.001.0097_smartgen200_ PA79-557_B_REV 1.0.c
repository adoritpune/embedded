...
* 08-05-23   REV 1.0                  Display shows  Set and Actual Current and actual Voltage
********************************************************************************
*/
...
void SetCurrentCal_200(void)
{
      if(ref2>=0 && ref2<=30)                              //10 to 50AMP, 13.47
           ref2=(((ref2*13.69)+100))/10;

      else if(ref2>30 && ref2<=75)                         //>50 to 100AMP,11.69
           ref2=((((ref2-30)*11.45)+500))/10;

     else if(ref2>75 && ref2<=119)                        //>100 to 150AMP,11.66
           ref2=((((ref2-75)*11.66)+1000))/10;   //12.53

     else if(ref2>119 && ref2<=155)                        //>150 to 200AMP
           ref2=((((ref2-119)*14.98)+1500))/10;  //14.49
