...
////////////////////////////////////mode selction and settings start///////////////////////////////
void key_application(unsigned char keypressed)//@called in main.c ==> while(1){ }
{
	if(keypressed =='A') 
	{
		...
		if((cMIGParaMenufg == 0) && (cGaSMenufg == 0) && (cModeSelectDonefg == 0)&& (cVRDMenufg == 0))
		{
			if(weldmode=='M')
			{
				weldmode='T';  //@versa400
	...
	else if((keypressed =='D'))// && (weldmode=='G')) 
	{
		if(weldmode == 'M') 
		{
			if(cMMAMenuMode==1)
			{
				iOffset = iOffset + 1;  //ioffset as islop
...
////////////////////////////////////mode selction and settings  End ///////////////////////////////
/* END keypad */
