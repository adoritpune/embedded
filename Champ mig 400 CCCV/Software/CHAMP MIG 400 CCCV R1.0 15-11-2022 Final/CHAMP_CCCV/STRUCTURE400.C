...
struct Type_S
{
	unsigned char mma			:1;	//1 
	unsigned char tig			:1;	//2	
	unsigned char mig			:1;	//3		
	unsigned char fourt	 		:1;	//4	
	unsigned char twot			:1;	//5	
	unsigned char voltage	  	:1;	//6 
	unsigned char current		:1;	//7	
	unsigned char wirespeed  	:1;	//8		TypeU.LEDGROUP[1]
	
	unsigned char mmaa			:1;
	unsigned char tiga	  		:1;
	unsigned char miga			:1;
	unsigned char pulsemiga		:1;
	unsigned char twota			:1;//  **************************************downslope	:1;
	unsigned char fourta		:1;
	unsigned char extra1a		:1;	
	unsigned char extra2a		:1; //2TypeU.LEDGROUP[2]
...
struct para_s
{
	...
	unsigned int 	tigdownslopetime;			//0052 5 tigdownslopetime;
	unsigned int 	tigpostflowtime;			//0053 6
...
union para_u const para_minu = {	
									...
									0,			//arcforce;					//0003
									1,			//mmaterial					//0004
									1,			//melctrodesize;			//0005
									1,			//melectrotype				//0006
																	
									0,			//preflow;					//0007
									10,			//startcurrent;				//0008
									0,			//upslopetime;				//0009
									10,			//setcurrent;				//0010
									10,			//endcurrent;				//0011
									1,			//tmaterial;				//0012
									...
									10,			//Twinpulsefreq 			//0047 0
									20,			//Twinpulseduty				//0048 1
									10,			//Twinpulseratio			//0049 2
									0,			//MIG Creepspeedrate		//0050 3
									
									25,			//Pulse Mig Creepspeedrate;	//0051 4
									0,			//tigdownslopetime;			//0052 5
									1,			//tigpostflowtime			//0053 6
									0,			//extra9;					//0054 7
									0			//extraa;					//0055 8
								};								
...
union para_u const para_maxu = {	
									...
									100,			//arcforce;				//0003
									3,				//mmaterial 			//0004
									4,				//melctrodesize;		//0005
									5,				//melectrotype;			//0006
																	
									50,				//preflow;				//0007
									400,			//startcurrent;			//0008
									100,			//upslopetime;			//0009
									400,			//setcurrent;			//0010
									400,			//endcurrent;			//0011
									2,				//tmaterial;			//0012
									6,				//tplatesize;			//0013
									...
									400,			//setcurrent;			//0016
									440,			//setvoltage;			//0017
									240,			//craterspeed;		//0018
									440,			//cratervoltage;		//0019
									20,			    //burnback;				//0020--------changed for mig testing 27-9-19
									240,			//setwspeed;			//0021
									100,			//thickness;			//0022
									50,				//postflow;				//0023
									0,				//gmaterial				//0024----added
									0,				//gdiameter				//0025----added
									0,				//ggas					//0026----addded
									100,			//inductance			//0027-----------added              changed for testing 7-10-19
																	
									10,				//preflow;				//0028
									400,			//setcurrent;			//0029
									440,			//setvoltage;			//0030
									400,		   	//cratercurrent;		//0031
									...
									80,	     		//Twinpulseduty			//0048 1
									50, 			//Twinpulseratio		//0049 2
									100, 	   		//Creepspeedrate		//0050 3
									
									100,			//pcreepspeedrate		//0051 4
									100,			//tigdownslopetime;		//0052 5
									200,			//tigpostflowtime		//0053 6
									0,				//extra9;				//0054 7
									0				//extraa;				//0055 8
								};				
...
struct error_s
{
	...
	unsigned char cable_error			:1;    	//6 Bit 
...
struct EEPROM_TMAT_TDIA_TJOINT                      //saurabh
{
    unsigned char tmat         		:2;
	unsigned char tdia  		    :6;
	unsigned char tjoint 	        :4;
	unsigned char Twot0_fourt1	    :1;
};



union EEPROM_STRUCTURE_UT
{
	struct EEPROM_TMAT_TDIA_TJOINT EEPROM_tmat_tdia_tjoint;
	unsigned char EEPROM_struct_ut;
};


union 	EEPROM_STRUCT_U 	EEPROM_struct_mig,EEPROM_struct_pmig;
union 	EEPROM_STRUCTURE_UT	EEPROM_struct_tig;
//union 	EEPROM_STRUCT		EEPROM_struct_mma;
...
#define EEPROMstruct_tig    EEPROM_struct_tig.EEPROM_tmat_tdia_tjoint              //saurabh
//#define EEPROMstruct_mma	EEPROM_struct_mma.EEPROM_VRD_Time
